...
public class ACQ2106_WRTDSetup extends DeviceSetup {
    ...
    private void initComponents() {
        ...
        deviceField2.setLabelString("Safe time to broadcasts message ID [DELTA in msec]");
        ...
        jTabbedPane1.addTab("WR RX / TX and Messages Filters", jTabbedPane3);
